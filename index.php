...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #4dd6cf;">
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  ...
                  <div class="col-md act">
                    ...
                    <img src="img/transfer.jpg" height="500" width="385" class="img-fluid">
                  ...
                  <div class="col-md act">
                    ...
                    <img src="img/history.jpg" height="350" width="290" class="img-fluid">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>KRISHNA HARIKA</b> </p>
      </footer>
